 ...
 */
public class ClassMetadataField1 extends ClassMetadataField
{
	public ClassMetadataField1(Field field)
	{		
        this.setField(field);
	...
	public ClassMetadataField1(ObjectStreamField field)
	{
		throw new RuntimeException("Constructor ClassMetadataField1(ObjectStreamField) should not be used for ClassMetadataField1");
	}
    ...
    {
    	throw new RuntimeException(this.getClass().getName() + " does not implement the method: getType()");
    }
