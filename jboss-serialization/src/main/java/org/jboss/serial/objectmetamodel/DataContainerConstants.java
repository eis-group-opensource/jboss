...
/**
 * $Id: DataContainerConstants.java 442 2013-05-14 14:26:08Z bmaxwell $
...
public interface DataContainerConstants
{
    ...
    public static byte[] openSign  = (!Compatability.SYNC_BINARY_FORMATS2) ? new byte[]{(byte)'j',(byte)'b',(byte)'s',(byte)'1',(byte)'{'} : new byte[]{(byte)'j',(byte)'b',(byte)'s',(byte)'2',(byte)'{'};
	public static byte[] closeSign = (!Compatability.SYNC_BINARY_FORMATS2) ? new byte[]{(byte)'j',(byte)'b',(byte)'s',(byte)'1',(byte)'}'} : new byte[]{(byte)'j',(byte)'b',(byte)'s',(byte)'2',(byte)'}'};
