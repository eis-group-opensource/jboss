...
/**
 * $Id: ObjectOutputStreamProxy.java 430 2013-04-26 23:17:59Z clebert.suconic@jboss.com $
 * @author Clebert Suconic
 */
public class ObjectOutputStreamProxy2 extends ObjectOutputStreamProxy
{

    private final Object currentObj;
    
    private final ClassMetaDataSlot currentMetaClass;
    
    private final ObjectSubstitutionInterface currentSubstitution;
    
    private FieldsContainer currentContainer = null;


    final ObjectOutput bout;
    
    public ObjectOutputStreamProxy2(ObjectOutput output, Object currentObj, ClassMetaDataSlot currentMetaClass, ObjectSubstitutionInterface currentSubstitution) throws IOException
    {
        super();
        this.bout=output;
    ...
    public void writeFields() throws IOException {
        ...
        {
        	RegularObjectPersister.writeSlotWithFieldsContainer(currentMetaClass, bout, currentContainer, currentSubstitution);
        }
        else
        {
