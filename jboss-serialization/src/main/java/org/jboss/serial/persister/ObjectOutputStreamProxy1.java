 ...
 */
public class ObjectOutputStreamProxy1 extends ObjectOutputStreamProxy
{
    ...
    ObjectOutput bout;
    public ObjectOutputStreamProxy1(ObjectOutput output, Object currentObj, ClassMetaDataSlot currentMetaClass, ObjectSubstitutionInterface currentSubstitution) throws IOException
    {        
        this.bout=output;
